...
<div id="boxes">
  <div style="top: 50%; left: 50%; display: none;" id="dialog" class="window">
    <div id="san">
      <a href="#" class="close agree"><img src="../../assets/img/icons/close-icon.png" width="25" style="float:right; margin-right: -25px; margin-top: -20px;"></a>
      <img class="responsive" src="../../assets/img/popup/pop-up.jpg">
    </div>
  </div>
      ...
      <div class="carousel-item" style="background-image: url(../../assets/img/slide/newslide-2.jpg)">
        <div class="carousel-container">
          <div class="container">
            ...
            <p class="animate__animated animate__fadeInUp">รักษ์ศักดิ์ศรี มีคุณธรรม นำวิชาการ สืบสานงานพระราชดำริ</p>
          </div>
        </div>
      </div>
            ...
            <td>
              ...
              <div class="card">
                ...
                <div class="card__body">
                  ...
                  <div class="wrapper">Lorem ipsum dolor sit amet consectetur</div>
                </div>
